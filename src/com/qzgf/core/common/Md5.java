 ...
 * File	         :MD5Ex.java
 * Written by     :fjfdszj
 * Created Date   :Sep 15, 2010
 * Purpose        :功能描述

======================================

 * Modifyer by    :fjfdszj
 * Update Date    :Sep 15, 2010
 * Purpose        :描述
...
public class Md5 {
	 ...
	 * MD5加密
	 */
	public synchronized static final String md5Simple(String data) {
		String result="";
		try {
			...
			result=encodeHex(digest.digest());
	...
	public static final String encodeHex(byte[] bytes) {
	 ...
	 { // 计算 "a" 的 MD5 代码，应该为：0cc175b9c0f1b6a831c399e269772661
	   System.out.println( Md5.getMD5("1".getBytes()) );
	   System.out.println( Md5.md5Simple("a") );
	 }
