 ...
 *
 */
public class FilterTranslatorBack {
	  //几个前缀/后缀
    ...
    public FilterTranslatorBack()
    {
    }

    public FilterTranslatorBack(FilterGroup group)
    {
        this.Group = group;
	...
	*/
	...
	public static void main( String xu[] ){
		...
		String teststr="{\"groups\":[{\"op\":\"and\"}],\"rules\":[{\"field\":\"username\",\"op\":\"equal\",\"value\":\"123\",\"type\":\"string\"},{\"field\":\"username\",\"op\":\"notequal\",\"value\":\"1234\",\"type\":\"string\"},{\"field\":\"nickname\",\"op\":\"equal\",\"value\":\"5656\",\"type\":\"string\"}],\"op\":\"and\"}";

		FilterTranslatorBack ft= new FilterTranslatorBack();
